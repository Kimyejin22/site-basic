...
sequelize.authenticate()
  .then(() => {
    console.log('Request Step2 Database connection has been established successfully.');
  })
  .catch(err => {
    console.error('Unable to connect to the Request Step2 database:', err.message);
  });

const Step2Data = sequelize.define('Step2Data', {
  selectedCategory: {
